    ...
    <main className="min-h-screen text-white">
      ...
      <header className="w-full px-6 pt-6">
        <div className="mx-auto max-w-6xl flex items-center justify-between">
          ...
          <Link
            href="/"
            className="text-white font-extrabold tracking-tight text-3xl md:text-4xl"
          >
            EverPay
          </Link>
      ...
      <section className="px-6 pt-10 pb-12">
        <div className="mx-auto max-w-6xl">
          <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-10 md:p-12 shadow-2xl">
            <div className="text-xs tracking-widest text-white/60 font-semibold">
            ...
            <p className="mt-4 max-w-2xl text-white/70 leading-relaxed">
              EverPay lets supporters send you a gift that routes directly to your
              bank. We do not store balances and we never hold your funds.
            </p>
  ...
  >
    View example
            ...
            <p className="mt-5 text-xs text-white/50">
              Payments are processed by Stripe and routed directly to creators.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="mt-2 text-white/60 text-sm">
                Add your name, profile picture, and links. Your EverPay page becomes
                your single shareable link.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="mt-2 text-white/60 text-sm">
                ...
                Funds route straight to your bank.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="mt-2 text-white/60 text-sm">
                Launching UK first with Stripe as the secure base.
              </p>
            </div>
          </div>
        </div>
